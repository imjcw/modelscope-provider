...
def test_frozen_keys_not_counted(repo):
    ...
    acc = repo.create(name="Frozen", api_key="k1", base_url="http://x")
...
def test_accounts_isolated(repo):
    ...
    a = repo.create(name="A", api_key="ka", base_url="http://x")
    b = repo.create(name="B", api_key="kb", base_url="http://x")
